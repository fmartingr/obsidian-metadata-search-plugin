...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/fmartingr/obsidian-book-search-plugin/Release%20Obsidian%20plugin?logo=github)
...
- [[옵시디언] '네이버 책 검색 API'를 사용하여 독서노트 생성하기](https://fmartingr.tistory.com/177)
- [[옵시디언] 책 검색 플러그인 (Book Search Plugin v0.1.0)](https://fmartingr.tistory.com/165)
